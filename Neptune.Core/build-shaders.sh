...
# Compile to SPIR-V
./Utilities/glslang/glslangValidator --aml -V -S vert ./Shaders/Vertex.glsl -o ./Shaders/Vertex.spv
./Utilities/glslang/glslangValidator --aml -V -S frag ./Shaders/Fragment.glsl -o ./Shaders/Fragment.spv
...
./Utilities/glslang/glslangValidator --aml -V -S vert ./Shaders/Vertex.450.glsl -o ./Shaders/Vertex.spv
./Utilities/glslang/glslangValidator --aml -V -S frag ./Shaders/Fragment.450.glsl -o ./Shaders/Fragment.spv
