...
namespace Neptune.Core
{
    public class ImageTexture
    {
        ...
        public ImageTexture(string path) : this(Image.Load(path), true) { }
        public ImageTexture(string path, bool mipmap) : this(Image.Load(path), mipmap) { }
        public ImageTexture(Image<Rgba32> image, bool mipmap = true)
        {
            if (mipmap)
            {
